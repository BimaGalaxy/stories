...
export const Toast = ({label = "label", variant = 'default', size = 'medium', message = "message" }: ToastProps) => {
    ...
    return (
        ...
        >
            <section className="flex items-center space-x-2">
                ...
                <button className={`text-black ${hoverColor} p-0.5 rounded-md -m-1 ${size === 'large' ? 'p-1 -m-1.5' : ''}`}>
